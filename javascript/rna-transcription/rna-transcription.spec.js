...
describe('toRna()', function() {
  ...
  it("transcribes all invalid dna nucleotides", function () {
    expect(dnaTranscriber.toRna('XXXX')).toEqual('');
  });

  it("transcribes partial invalid dna nucleotides", function () {
    expect(dnaTranscriber.toRna('XCXGXAXTX')).toEqual('GCUA');
  });
});
